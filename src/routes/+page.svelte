    ...
    <div class="hero-bottom fade-in fade-in-3">
      ...
      <div class="hero-lead-cta">
        <div class="hero-cta-buttons">
          <a href="/iletisim" class="btn btn-primary">{$t('pages.home.cta1')} <Icon name="Arrow" size={16}/></a>
          <a href="/hizmetler" class="btn btn-ghost">{$t('pages.home.cta2')}</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="services">
  <div class="container">
    <div class="section-head">
      ...
      <a href="/hizmetler" class="head-cta">{$t('footer.servicesTitle')} <Icon name="ArrowUR" size={14}/></a>
    </div>
...
<section style="background: var(--bg-deep); border-top: 1px solid var(--line); border-bottom: 1px solid var(--line)">
  <div class="container">
    <div class="section-head">
      ...
      <a href="/projeler" class="head-cta">{$t('nav.projects')} <Icon name="ArrowUR" size={14}/></a>
